...
public class Player extends GameObject {
    ...
    public void keyDownEvent(GameKeyCode key) {
        ...
        if ((key == GameKeyCode.NUM_1 || key == GameKeyCode.NUM_2 || key == GameKeyCode.NUM_3
            ...
            setSprite(GameSpriteFactory.getPlayerSprite(PlayerMotion.IDLE, ((WeaponItem) inventory.get(currentItemIndex)).getType()));
    ...
    public void collisionEvent(GameObject other) {
        ...
        if (other instanceof WeaponObject && inventory.size() < 4) {
            ...
            inventory.add(new WeaponItem(weaponObject.getName(), weaponObject.getWeaponType(), weaponObject.getDamage(),
                    weaponObject.getDurability(), GameSpriteFactory.getInventorySprite(weaponObject.getWeaponType())));
    ...
    public void mouseClickedEvent(MouseButton button, double x, double y) {
        if (button.equals(MouseButton.PRIMARY)) {
            if (inventory.get(currentItemIndex) instanceof WeaponItem) {
